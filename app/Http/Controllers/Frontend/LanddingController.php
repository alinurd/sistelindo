...
class LanddingController extends Controller
{
    public function index()
    {
        ...
        $data['product'] = Product::where('status', 1)->orderby('sort', 'asc')->get()->toarray();
        $data['customer'] = Customer::where('status', 1)->orderby('sort', 'asc')->get();
                $data['PageDetailAbout'] = PageDetail::where('status', 1)->orderby('sort', 'asc')->get();
                $data['galleries'] = Gallery::where('status', 1)->orderby('sort', 'asc')->get()->toarray();
