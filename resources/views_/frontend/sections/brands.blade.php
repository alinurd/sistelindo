<section class="py-5 trusted-section  animate-fade-in">
    <div class="container text-center">
        ...
        <!-- TITLE -->
         ...
         <p class="mt-3 mx-auto desc" style="font-size: 18px">
        ...
        <div class="contact-box shadow-sm p-4 rounded-3" style="min-height: 350px; height: 350px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
                <br><br>
