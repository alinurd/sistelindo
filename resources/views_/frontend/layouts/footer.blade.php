...
<footer>
    <div class="container footer-content">
        ...
        <div class="footer-social">
            ...
            <img src="{{ asset('assets/img/material/6.png')}}" width="70" class="rounded" alt="icon">
            <img src="{{ asset('assets/img/material/7.png')}}"width="90" height="80" class="rounded" alt="icon">
        </div>
        </div>
