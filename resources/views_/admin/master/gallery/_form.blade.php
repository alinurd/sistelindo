<form class="form" id="formData">
  ...
  <div class="btn-group" role="group">
    ...
    <div class="mb-3">
        <label for="type" class="form-label">Gallery Type</label>
...
<div class="row" id="video-wrapper">
  <div class="col mb-3">
    <div class="border rounded p-3">
      ...
      <div class="mb-3">
        <label for="video-embed" class="form-label">Embed Link</label>
        <div class="input-group">
          <input type="hidden" id="media" name="media" class="form-control" readonly>
          <input type="text" id="video-embed" name="link" class="form-control" readonly>
          <span class="input-group-text fw-bold" id="video-platform">-</span>
        </div>
      </div>

      <!-- Preview -->
      <div id="video-preview" class="text-center border rounded p-3 bg-light">
