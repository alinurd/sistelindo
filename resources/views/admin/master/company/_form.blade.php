...
<form class="form" id="formData">
  ...
  <div class="mb-3">
    <label for="review" id="label-review" class="form-label">Company Review</label>
    <textarea name="review" id="review" class="form-control"></textarea>
  </div>

  <div class="mb-3">
    <label for="vision" id="label-vision" class="form-label">Company Vision</label>
    <textarea name="vision" id="vision" class="form-control"></textarea>
  </div>

  <div class="mb-3">
    <label for="mission" id="label-mission" class="form-label">Company Mission</label>
    <textarea name="mission" id="mission" class="form-control"></textarea>
  </div>

  <div class="mb-3">
    <label for="service" id="label-service" class="form-label">Internet Service</label>
    <textarea name="service" id="service" class="form-control">Sistem Komunikasi</textarea>
  </div>

  <div class="mb-3">
    <label for="lisensi" id="label-lisensi" class="form-label">Lisensi ITKP</label>
