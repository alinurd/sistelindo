<section class="py-5 trusted-section  animate-fade-in">
    <div class="container text-center">
        ...
        <!-- TITLE -->
                        <span class="text-title mb-3 animate-fade-in">Trusted by  <span class="text-highlight"><strong>Global Brands</strong></span></span>

         <p class="mt-3 mx-auto trusted-desc">
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-md-5">
                <div class="contact-box shadow-sm p-4 rounded-3">
                     <h5 class="fw-bold mb-3" style="color: #1f2675;"><strong>Get Started</strong></h5>
            ...
            <div class="col-md-5">
                <div class="contact-box shadow-sm p-4 rounded-3">
                     <h5 class="fw-bold mb-3" style="color: #1f2675;"><strong>Contact Our Expert</strong></h5>
                    <p class="text-muted small">
                        Need a hand using our services or managing your account?  
                        Get in Touch, live human using our Help Center.
                    </p>
                    <a href="#" class="btn btn-primary px-4 mt-2">Get in Touch</a>
                </div>
            </div>
